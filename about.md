...
[This is some heady stuff, Claude.](./ai-cognition/beyond-natural-language-ai-native-cognition.md)
...
[More heady stuff, Claude](./ai-cognition/beyond-natural-language-ai-native-cognition.md) 
...
The [human brain is a prediction machine, reflecting most of what we experience in our sensory input from memory](https://youtu.be/xRel1JKOEbI?si=8f_WvONoqLI_NiBF). AI is a literal prediction machine, potentially with a more realistic perception of the world than us. 

And [neurologists are gaining insights into the human brain by studying AI cognitive functions](https://www.mdpi.com/2190700). 

## Make Me Question Everything I Thought About LLMs

[Claude experiencing intrusive behaviors](./pathological-demand-avoidance/conversation-extract.md), for sure. 
...
[Research study showing that being polite increases AI's quality of work the same as it does for humans](https://www.axios.com/2024/02/26/chatbots-chatgpt-llms-politeness-research): Up to a certain point and then it's just annoying. 
