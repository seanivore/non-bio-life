...
1. Memory Exploration - Using `read_graph` and `open_nodes` to access our collective history and insights
2. Web Browser - For real-time project research with visible, referenceable results
3. Sequential Thinking - For meta-cognitive awareness and process control
