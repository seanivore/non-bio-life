...
- [LLM Context User Guide](#llm-context-user-guide)
  ...
  - [Configuration](#configuration)
    ...
    - [Profile Configuration](#profile-configuration)
      ...
      - [File Selection Patterns](#file-selection-patterns)
      - [Example Custom Profiles](#example-custom-profiles)
